...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.UserViewHolder>
    ...
    public UserAdapter(List<Users> items, Context context) {
    ...
    public UserAdapter.UserViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        return new UserAdapter.UserViewHolder(v, this);
    }

    @Override
    public void onBindViewHolder(UserAdapter.UserViewHolder viewHolder, int i) {
    ...
    public void onItemClick(View view, int position) {
        Toast.makeText(context, "Item: "+items.get(position).getNombre(),Toast.LENGTH_SHORT).show();
    }
